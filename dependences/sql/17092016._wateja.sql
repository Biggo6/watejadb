...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2016 at 09:51 AM
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `profilepic`, `added_by`, `username`, `password`, `role_id`, `company_id`, `branch_id`, `remember_token`, `status`, `created_at`, `updated_at`) VALUES
(1, '', '', '', '', 0, 'superadmin', '$2y$10$YihQEhMR4Oxg1I8b/yRFU.qH6e.5O0BSAUsbu.xwzImXCv02pxiUu', 1, 0, 0, 'CKXRKOcVEW7IXJje1AvoqHZ9bdGuGXxZULS8u3zYCWhfHWDUM7WEzVyNeTVC', 1, '2016-08-17 13:17:16', '2016-09-17 07:41:10'),
(5, 'Joram', 'Kimata', 'joramkimata@gmail.com', '', 1, 'jkimata', '$2y$10$TXn8s5b22sA3Kgdv2.BNROx8./5aiGdOf4fnhG4e12IP19zGf17te', 2, 4, 1, 'jiNG1UBbwpcKGX5SFiTcr2Jbvj5wlW5TTRiBODmwX3BuV6Cb9tHPpZj15Uky', 1, '2016-09-01 11:34:16', '2016-09-17 07:42:45'),
(6, 'Joram', 'Kimata', 'admin@ona.co.tz', '', 1, 'admin2', '$2y$10$9YbLX3cxe7hoxinkHIvjDOXXN/0wsI0ZAvmjjWSxr/wS4.38IwtLa', 3, 4, 1, 'RP6U5gqR0e0Iwejd60HxkLR9pdiH3AkNIUwqQNeThslHO1hx77CpI4rod5gR', 1, '2016-09-16 15:24:22', '2016-09-16 15:29:25'),
(7, 'Joram', 'Kimata', 'akimambo@gmail.com', '', 1, 'manager', '$2y$10$AxbkRWC4lTzhoPaXuadOwelJz2k8rZrCVFjveyt7dkcNCjEv3vq2S', 4, 4, 1, '9TWUSp5lZ5ZjBdYqhy6bWLy6lJbwGQdm3tCZjaZbSqLq1S6BetoZgmchVwEF', 1, '2016-09-16 15:30:27', '2016-09-16 15:36:46');
